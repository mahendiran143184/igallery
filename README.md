...
<body>
    <header style="text-align: center; background-color: #bd0787; color: white; padding: 1rem 0;">
        <h1>CARTOONS</h1>
    </header>
...
```
## OUTPUT:
<img width="1911" height="946" alt="image" src="https://github.com/user-attachments/assets/227e3634-c4bc-42a9-8813-e6ecc530ab14" />
